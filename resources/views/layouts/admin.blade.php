...
<head>
    ...
    <meta name="description" content="HamsSkie Laundry">
    <meta name="author" content="Achmad Ilham M.A">

    <!-- CSRF Token -->
    <meta name="csrf-token" content="{{ csrf_token() }}">

    <title>HamsSkie Express Laundry</title>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; ilham_03</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
